...
import hydra
import torch
print("#######training toch version########", torch.__version__)
...
def train(exp_dict: DictConfig):
    ...
    # model_path = "/Users/xiaohye/Documents/SPLADE/splade-main/saved_models/toy_model/"

    # torch.save(model.state_dict(), f"{model_path}/pytorch_model.bin")

    # torch.save(model, f"{model_path}/toy_finetuned_model.pt")
    print("+++++ MODEL SAVED +++++")
